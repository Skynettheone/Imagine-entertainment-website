...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-16 md:pt-20 lg:pt-24 pb-6 md:pb-8 px-6 md:px-8 mx-4 md:mx-6 rounded-3xl bg-stone-100 dark:bg-zinc-950 text-foreground dark:text-white overflow-hidden">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid md:grid-cols-12 gap-4 md:gap-6">
            {/* Hero Stat - Large */}
            <div className="md:col-span-7 group relative overflow-hidden rounded-2xl bg-white/80 dark:bg-white/10 border border-stone-200/50 dark:border-transparent p-10 md:p-14 lg:p-16">
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-baseline gap-4 mb-6">
                  <h3 className="text-8xl md:text-9xl lg:text-[12rem] font-bold tracking-tighter leading-none">
                    37
                  </h3>
            ...
            <div className="md:col-span-5 flex flex-col gap-4 md:gap-6">
              {/* Events Stat */}
              <div className="group relative overflow-hidden rounded-2xl bg-white/80 dark:bg-white/10 border border-stone-200/50 dark:border-transparent p-8 md:p-10 flex-1">
                ...
                <div className="relative z-10 h-full flex flex-col justify-between">
                  ...
                  <div>
                    <h3 className="text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-none">
                      500<span className="text-muted-foreground/50 dark:text-white/30">+</span>
                    </h3>
              ...
              <div className="group relative overflow-hidden rounded-2xl bg-white/80 dark:bg-white/10 border border-stone-200/50 dark:border-transparent p-8 md:p-10 flex-1">
                ...
                <div className="relative z-10 h-full flex flex-col justify-between">
                  ...
                  <div>
                    <h3 className="text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-none">
                      98<span className="text-muted-foreground/50 dark:text-white/30">%</span>
                    </h3>
            ...
            <div className="md:col-span-4 group relative overflow-hidden rounded-2xl bg-white/80 dark:bg-white/10 border border-stone-200/50 dark:border-transparent p-8 md:p-10">
              <div>
                <p className="text-muted-foreground dark:text-white/50 text-xs tracking-[0.3em] uppercase mb-3">Team Size</p>
                <h3 className="text-5xl md:text-6xl font-bold tracking-tighter">50<span className="text-muted-foreground/50 dark:text-white/30">+</span></h3>
              </div>
            </div>
            ...
            <div className="md:col-span-4 group relative overflow-hidden rounded-2xl bg-white/80 dark:bg-white/10 border border-stone-200/50 dark:border-transparent p-8 md:p-10">
              <div>
                ...
                <h3 className="text-5xl md:text-6xl font-bold tracking-tighter">15<span className="text-muted-foreground/50 dark:text-white/30">+</span></h3>
              </div>
            </div>
            ...
            <div className="md:col-span-4 group relative overflow-hidden rounded-2xl bg-white/80 dark:bg-white/10 border border-stone-200/50 dark:border-transparent p-8 md:p-10">
              <div>
                ...
                <h3 className="text-5xl md:text-6xl font-bold tracking-tighter">25<span className="text-muted-foreground/50 dark:text-white/30">+</span></h3>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Team Section */}
      <section className="pt-16 md:pt-20 lg:pt-24 pb-8 md:pb-10 lg:pb-12">
        {/* Header */}
        ...
        <div className="mx-4 md:mx-6 rounded-2xl overflow-hidden">
